...
@Service
@Primary
public class FakeStoreProductManagementService implements ProductManagementService {
    ...
    FakeStoreProductManagementService(RestTemplateBuilder restTemplateBuilder) {
